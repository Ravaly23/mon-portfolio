  ...
  return (
    <div className="min-h-screen bg-[#0a0a0f] text-[#e8e8ec]">
      <header className="dark:bg-gray-950 backdrop-blur-md pt-4 pb-4 pl-10 pr-20">
        <nav className="flex items-center justify-around gap-x-115 md:gap-x-170">
          ...
          <ul className="hidden md:flex pt-2 justify-between  text-xl md:gap-x-4">
            <LienNavigation />
          </ul>
          <div className="md:hidden">
            ...
            {isOpen && (
              <>
                <nav className="flex flex-col fixed bg-[#0a0a0f] text-2xl w-30 items-center">
                  <div className={`border-blue-900 bg-[#0a0a0f] w-6 h-6 rotate-45 mr-18 -mt-1`}></div>
                  <LienNavigation />
                </nav>
              </>
            )}
